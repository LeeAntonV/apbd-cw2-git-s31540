...
internal class Program
{
    ...
    {
        rentalService.AddUser(new Student("Antoha", "Lee"));
        rentalService.AddUser(new Student("Anton", "Lee"));
        rentalService.AddUser(new Employee("Antonio", "Lee"));
        ...
        rentalService.AddEquipment(new Projector("Epson EB-FH06", "Lecture hall projector", 3500, "1920x1080", "SupTech"));
